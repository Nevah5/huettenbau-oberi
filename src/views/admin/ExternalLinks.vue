<template>
  <div>
    ...
    <p class="mb-4">
      Um auf eine externe Seite weiterleiten zu können, musst du hier einen
      Externen Link erstellen.<br />
...
import ExternalLinkManagment from "@/components/admin/ExternalLinkManagment.vue";
</script>
